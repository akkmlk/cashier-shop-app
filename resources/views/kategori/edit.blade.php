...
@section('content')
    <div class="row">
        <div class="col-xl-4 col-lg-6">
            <form action="{{ route('kategori.update', $kategori->id) }}" method="POST" class="card card-orange card-outline">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_kategori" value="{{ $kategori->nama_kategori }}" class="form-control @error('nama_kategori') is-invalid @enderror" autofocus>
                        @error('nama_kategori')
